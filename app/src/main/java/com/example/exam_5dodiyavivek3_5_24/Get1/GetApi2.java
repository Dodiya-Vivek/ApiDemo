...
import com.example.exam_5dodiyavivek3_5_24.Get3.Adapter2;
...
public class GetApi2 extends AppCompatActivity {

    RecyclerView recyclerView;
    Adapter2 adapter3;
    List<Model2> Products1;
    Button btnnext1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnnext1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GetApi2.this, GetApi3.class);
                startActivity(intent);
            }
        });

        Products1 = new ArrayList<Model2>();

        recyclerView = findViewById(R.id.recycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        adapter3 = new Adapter2(Products1,this);
